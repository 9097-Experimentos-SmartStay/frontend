...
| `/staff/hotels`, `/staff/hotels/new`, `/staff/hotels/:hotelId/edit` | Lectura: personal; registro: `admin` sin hotel, `chain_admin` | US-53: un hotel por administrador; errores por campo; no se borra un hotel con reservas activas. |
