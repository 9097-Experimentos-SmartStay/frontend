...
export const Capability = Object.freeze({
    ...
    VIEW_BOOKING_CALENDAR: 'viewBookingCalendar',
    MANAGE_BOOKINGS: 'manageBookings',
    REGISTER_PAYMENTS: 'registerPayments',
...
const CAPABILITY_ROLES = Object.freeze({
    ...
    [Capability.CHANGE_ROOM_STATUS]: STAFF_ROLES,
    ...
    [Capability.VIEW_BOOKING_CALENDAR]: [RECEPTION, ADMIN, CHAIN_ADMIN],
    [Capability.MANAGE_BOOKINGS]: [RECEPTION, ADMIN, CHAIN_ADMIN],
    [Capability.REGISTER_PAYMENTS]: [RECEPTION, ADMIN, CHAIN_ADMIN],
