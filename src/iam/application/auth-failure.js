...
export const AuthFailureReason = Object.freeze({
    ...
    MFA_CODE_ALREADY_USED: 'mfaCodeAlreadyUsed',
    MFA_RECOVERY_CODE_INVALID: 'mfaRecoveryCodeInvalid',
    MFA_CHALLENGE_EXPIRED: 'mfaChallengeExpired',
    MFA_ENROLLMENT_NOT_STARTED: 'mfaEnrollmentNotStarted',
    MFA_ALREADY_ENABLED: 'mfaAlreadyEnabled',
